...
class ReminderLogPolicy
{
    ...
    {
        return $user->can('view_any_reminder::log');
    }
    ...
    {
        return $user->can('view_reminder::log');
    }
    ...
    {
        return $user->can('create_reminder::log');
    }
    ...
    {
        return $user->can('update_reminder::log');
    }
    ...
    {
        return $user->can('delete_reminder::log');
    }
    ...
    {
        return $user->can('delete_any_reminder::log');
    }
